        ...
        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly w-[100%]">
          <aside className="w-[21%]">
            <div className="">
              <Column className="bg-gray_50 border-bw15 border-gray_100 border-solid flex flex-col justify-start sm:py-[15px] md:py-[23px] py-[34px] w-[100%]">
                ...
                <Stack className="font-urbanist h-[258px] max-w-[234px] sm:ml-[18px] md:ml-[23px] sm:mt-[153px] md:mt-[198px] mt-[289px] mx-[auto] sm:px-[15px] relative w-[100%]">
          ...
          <Column className="flex flex-col items-center max-w-[1138px] sm:mx-[0] mx-[auto] sm:px-[15px] w-[100%]">
            ...
            <Column className="flex flex-col font-urbanist justify-start sm:mt-[20px] md:mt-[26px] mt-[39px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[95%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[12px] md:mt-[16px] mt-[24px] sm:px-[0] rounded-radius14 w-[100%]">
                <Button
              ...
              <Grid className="sm:gap-[10px] md:gap-[13px] gap-[19px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 min-h-[auto] sm:mt-[15px] md:mt-[20px] mt-[30px] w-[100%]">
                <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                  ...
                  <Column className="flex flex-col justify-start mb-[12px] sm:mb-[6px] md:mb-[8px] sm:mt-[10px] md:mt-[13px] mt-[20px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                    <Column className="flex flex-col justify-start sm:mx-[0] pr-[3px] pt-[3px] sm:px-[0] sm:w-[100%] w-[74%]">
                      <Text
                        className="font-semibold mt-[1px] text-black_900 tracking-ls016 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                        as="h6"
                        variant="h6"
                      >
              ...
              <Button
                className="cursor-pointer font-medium min-w-[10%] sm:ml-[257px] md:ml-[332px] ml-[483px] sm:mt-[26px] md:mt-[34px] mt-[50px] text-[14px] text-center tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                shape="RoundedBorder10"
                size="md"
