        ...
        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start max-w-[1138px] sm:mx-[0] mx-[auto] sm:px-[15px] w-[100%]">
            ...
            <Column className="flex flex-col font-urbanist justify-start sm:mt-[18px] md:mt-[23px] mt-[34px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
              <Row className="bg-gray_50 flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:p-[3px] md:p-[4px] p-[6px] rounded-radius8 sm:w-[100%] w-[19%]">
                <Text
                  className="font-medium ml-[10px] sm:ml-[5px] md:ml-[6px] mt-[3px] text-gray_500 tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                  variant="body1"
                >
                  Marketplace
                </Text>
                <Text
                  className="font-medium sm:ml-[4px] md:ml-[5px] ml-[8px] my-[1px] text-gray_500 tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                  variant="body1"
                >
                  {">"}
                </Text>
                <Text
                  className="font-medium sm:ml-[4px] md:ml-[5px] ml-[8px] mt-[3px] text-gray_900 tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                  variant="body1"
                >
                  Open Bid
                </Text>
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[18px] md:mt-[23px] mt-[34px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                <Img
                  ...
                  alt="Rectangle2054"
                />
                <Column className="flex flex-col sm:mx-[0] sm:pt-[4px] md:pt-[5px] pt-[8px] sm:px-[0] sm:w-[100%] w-[48%]">
                  <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                    ...
                    <Text
                      className="font-normal leading-[180.00%] sm:mt-[14px] md:mt-[18px] mt-[27px] not-italic text-gray_500_ab tracking-ls016 md:tracking-ls1 sm:tracking-ls1 w-[100%]"
                      as="h6"
                      variant="h6"
                    >
                  ...
                  <List
                    className="sm:gap-[17px] md:gap-[22px] gap-[32px] grid sm:grid-cols-1 grid-cols-2 min-h-[auto] sm:mt-[13px] md:mt-[17px] mt-[25px] sm:w-[100%] w-[70%]"
                  ...
                  >
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:px-[0] w-[100%]">
                      ...
                      <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[63%]">
                        ...
                        <Text
                          className="font-semibold sm:mt-[3px] md:mt-[4px] mt-[6px] text-black_900 tracking-ls016 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          Eleanor Pena
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mr-[auto] sm:mt-[11px] md:mt-[14px] mt-[21px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                    <Column className="flex flex-col justify-start mt-[2px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[63%]">
                      <Text
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[81%]">
                        <Button
                          className="cursor-pointer font-semibold sm:h-[24px] md:h-[31px] h-[44px] text-[20px] text-center tracking-ls02 md:tracking-ls1 sm:tracking-ls1 sm:w-[23px] md:w-[30px] w-[44px]"
                          shape="RoundedBorder10"
                          size="md"
                          variant="FillGray50"
                        >
                        ...
                        <Img
                          src="images/img_.svg"
                          className="max-w-[100%] sm:ml-[4px] md:ml-[5px] ml-[8px] w-[2%]"
                          alt="Two"
                        />
                        <Button
                          className="cursor-pointer font-semibold sm:h-[24px] md:h-[31px] h-[44px] sm:ml-[4px] md:ml-[5px] ml-[8px] text-[20px] text-center tracking-ls02 md:tracking-ls1 sm:tracking-ls1 sm:w-[23px] md:w-[30px] w-[44px]"
                          shape="RoundedBorder10"
                          size="md"
                          variant="FillGray50"
                        >
                    ...
                    <Column className="flex flex-col justify-start sm:mx-[0] pr-[2px] pt-[2px] sm:px-[0] sm:w-[100%] w-[38%]">
                      <Text
                        className="font-medium text-gray_500_ab tracking-ls016 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                        as="h6"
                        variant="h6"
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[11px] md:mt-[15px] mt-[22px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                        <Img
                          src="images/img_sort.svg"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mr-[auto] sm:mt-[19px] md:mt-[25px] mt-[37px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[56%]">
                    <Button
                    ...
                    <Button
                      className="cursor-pointer font-medium min-w-[77%] ml-[14px] sm:ml-[7px] md:ml-[9px] text-[14px] text-center tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                      shape="RoundedBorder10"
                      size="xl"
                      variant="FillGray900"
                    >
                ...
                >
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      ...
                      style={{
                        backgroundImage: "url('images/img_duration_14.png')",
                      }}
                    >
                      <Button
                    ...
                    <Column className="flex flex-col justify-start mb-[12px] sm:mb-[6px] md:mb-[8px] sm:mt-[12px] md:mt-[16px] mt-[24px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      className="bg-cover bg-no-repeat flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end sm:p-[4px] md:p-[5px] p-[8px] rounded-radius12 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_duration_15.png')",
                      }}
                    >
                      <Button
                        className="cursor-pointer font-medium sm:mb-[50px] md:mb-[65px] mb-[95px] min-w-[34%] mt-[1px] text-[12px] text-center tracking-ls012 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                    ...
                    <Column className="flex flex-col justify-start mb-[12px] sm:mb-[6px] md:mb-[8px] sm:mt-[10px] md:mt-[13px] mt-[20px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                      <Column className="flex flex-col justify-start sm:mx-[0] pr-[3px] pt-[3px] sm:px-[0] sm:w-[100%] w-[74%]">
                        <Text
                          className="font-semibold text-black_900 tracking-ls016 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                          as="h6"
                          variant="h6"
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      className="bg-cover bg-no-repeat flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end sm:p-[4px] md:p-[5px] p-[8px] rounded-radius12 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_duration_16.png')",
                      }}
                    >
                      <Button
                        className="cursor-pointer font-medium sm:mb-[50px] md:mb-[65px] mb-[95px] min-w-[34%] mt-[1px] text-[12px] text-center tracking-ls012 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      className="bg-cover bg-no-repeat flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end sm:p-[4px] md:p-[5px] p-[8px] rounded-radius12 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_duration_17.png')",
                      }}
                    >
                      <Button
                        className="cursor-pointer font-medium sm:mb-[50px] md:mb-[65px] mb-[95px] min-w-[34%] mt-[1px] text-[12px] text-center tracking-ls012 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
