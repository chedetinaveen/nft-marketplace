            ...
            <Stack className="font-urbanist h-[940px] relative w-[100%]">
              ...
              <Column className="absolute bg-white_A700 flex flex-col items-center justify-center left-[3%] sm:mx-[0] md:p-[12px] sm:p-[15px] p-[18px] rounded-radius15 shadow-bs1 top-[19%] sm:w-[100%] w-[22%]">
                <Column className="flex flex-col items-center justify-start md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mt-[14px] md:mt-[19px] mt-[28px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
                    <Img
                ...
                <Text
                  className="font-normal mb-[10px] sm:mb-[5px] md:mb-[6px] sm:mt-[15px] md:mt-[19px] mt-[29px] not-italic text-gray_500 tracking-ls014 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                  variant="body1"
                >
                  Joined April 2021
                </Text>
              ...
              <Column className="absolute bottom-[0] flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] right-[3%] sm:w-[100%] w-[70%]">
                ...
                <Grid className="sm:gap-[10px] md:gap-[13px] gap-[19px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 min-h-[auto] sm:mt-[18px] md:mt-[23px] mt-[34px] w-[100%]">
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      className="bg-cover bg-no-repeat flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end sm:p-[4px] md:p-[5px] p-[8px] rounded-radius12 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_duration_18.png')",
                      }}
                    >
                      <Text
                        className="bg-gray_900_26 font-medium sm:mb-[50px] md:mb-[65px] mb-[95px] mt-[1px] sm:pb-[4px] md:pb-[6px] pb-[9px] pl-[10px] sm:pl-[5px] md:pl-[6px] sm:pr-[15px] md:pr-[21px] pr-[31px] sm:pt-[3px] md:pt-[4px] pt-[6px] rounded-radius14 text-white_A700 tracking-ls012 md:tracking-ls1 sm:tracking-ls1 w-[75px]"
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[3px] md:p-[4px] p-[6px] rounded-radius15 shadow-bs1 w-[100%]">
                    <Row
                      className="bg-cover bg-no-repeat flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end sm:p-[4px] md:p-[5px] p-[8px] rounded-radius12 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_duration_19.png')",
                      }}
                    >
                      <Button
                        className="cursor-pointer font-medium sm:mb-[50px] md:mb-[65px] mb-[95px] min-w-[34%] mt-[1px] text-[12px] text-center tracking-ls012 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
